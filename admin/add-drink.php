        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td>Drink_Size: </td>
                    <td>
                        <input type="text" name="drink_size" placeholder="Size of the Drink">
                    </td>
                </tr>
                <tr>
                    <td>Description: </td>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "Drink-Name-".rand(0000,9999).".".$ext; //New Image Name May Be "Food-Name-657.jpg"
